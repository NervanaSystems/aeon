...
directory_entry directory_entry::read(bstream_base& bs)
{
    ...
    for (int i = 0; i < directory_count; i++)
    {
        ...
        switch (tag)
        {
        case tag_type::ImageWidth: rc.image_width   = read_value(type, bs); break;
        case tag_type::ImageLength: rc.image_length = read_value(type, bs); break;
        ...
        case tag_type::StripByteCounts:
            ...
            break;
        case tag_type::XResolution: value_offset    = bs.readU32(); break;
        case tag_type::YResolution: value_offset    = bs.readU32(); break;
        case tag_type::ResolutionUnit: value_offset = bs.readU32(); break;
        case tag_type::SamplesPerPixel: rc.channels = read_value(type, bs); break;
        case tag_type::PlanarConfiguration:
            ...
            break;
        case tag_type::BitsPerSample: rc.bits_per_sample_offset = read_value(type, bs); break;
        case tag_type::SampleFormat:
            cout << __FILE__ << " " << __LINE__ << " " << count << endl;
            value_offset = bs.readU32();
            break;
        default: value_offset = bs.readU32(); cout << "unknow tag " << (tag_type)tag << endl;
        }
    }
...
cv::Mat directory_entry::read_image(bstream_base& bs) const
{
    ...
    default: throw std::invalid_argument("bits per sample must be 8 or 16");
    }
