...
{
    {
        ...
        EXPECT_STREQ("", path_join(s1, s2).c_str());
    }
    {
        string s1 = "";
        string s2 = "/test1/test2";

        EXPECT_STREQ("/test1/test2", path_join(s1, s2).c_str());
    }
    {
        string s1 = "";
        string s2 = "/test1/test2/";
...

    {
        ...
        EXPECT_STREQ("/x1/x2", path_join(s1, s2).c_str());
    }
    {
        string s1 = "/x1/x2/";
        string s2 = "/";
    ...
    }
    {
        ...
        EXPECT_STREQ("/x1/x2/test1/test2", path_join(s1, s2).c_str());
    }
    {
        string s1 = "/x1/x2";
        string s2 = "test1/test2";
