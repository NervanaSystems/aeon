...
void audio_classifier::provide(int idx, encoded_record_list& in_buf, fixed_buffer_map& out_buf)
{
    ...
    auto audio_params = audio_factory.make_params();
