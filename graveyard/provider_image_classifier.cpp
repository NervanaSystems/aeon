...
void image_classifier::provide(int idx, encoded_record_list& in_buf, fixed_buffer_map& out_buf)
{
    ...
    auto image_size = image_dec->get_image_size();
    auto image_params = image_factory.make_params(image_size.width, image_size.height);
