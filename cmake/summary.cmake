...
function(print_configuration_summary)
    ...
    if(SANITIZER_TYPE)
        report_status("    Sanitizer Type             : ${SANITIZER_TYPE}")
    endif()
    report_status("")
    ...
    report_status("    AEON Python Interface      : " Python_FOUND THEN "Yes" ELSE "No (Python not found, see details below)")
    ...
    report_status("    Interpreter                : " Python_Interpreter_FOUND THEN "${Python_EXECUTABLE} (ver. ${Python_VERSION})" ELSE "No")
    report_status("    Libraries                  : " Python_Development_FOUND THEN "${Python_LIBRARIES}${APPEND_VER_IF_PRESENT}" ELSE "No")
    report_status("    NumPy                      : " Python_NumPy_FOUND THEN "${Python_NUMPY_INCLUDE_DIRS} (ver. ${Python_NumPy_VERSION})" ELSE "No")
    report_status("")
