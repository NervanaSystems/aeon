...
# breathe for doxygen docs into sphinx
breathe_projects = { "aeon_doxygen": os.path.abspath('../build/doxy/xml') }
breathe_default_project = "aeon_doxygen"
...
latex_documents = [('index', 'aeon.tex', u'aeon Documentation',
...
texinfo_documents = [('index', 'aeon', u'aeon Documentation',
                      u'Nervana Systems Inc', 'aeon',
